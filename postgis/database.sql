...
--
-- Name: ploomap_ratiodisc_row; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public.ploomap_ratiodisc_row OWNER TO postgres;
...
--
-- Name: ploomap_ratiodisc_width(integer, integer, real, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.ploomap_ratiodisc_width(ep_min integer, ep_max integer, seuil real, query character varying) OWNER TO postgres;
